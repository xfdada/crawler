...
<body>
<div style="margin-top: 50px;margin-left: 100px"><a class="layui-btn layui-btn-danger" href="{{route('fail.index')}}">未处理文章</a><a class="layui-btn layui-btn-normal" style="margin-left: 20px;" href="{{url('/index')}}">爬取文章</a></div>
...
<script>
    ...
    function article_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            // alert(id);
            $.post('{{url('article/')}}/'+id,{'_token':'{{csrf_token()}}','_method':'delete' },function(res){
                if(res.code==1){
